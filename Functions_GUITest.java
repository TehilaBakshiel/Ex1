...
class Functions_GUITest {
    ...
    //	data.drawFunctions(w,h,rx,ry,res);
		...
		try {
			...
			data.drawFunctions(5, 8, new Range(-10, 10), new Range(-5, 15), 6);
...
//	}
	...
	public static functions FunctionsFactory() {
		...
		//System.out.println(cf3+"telepun");
		//System.out.println(s3.length);
		for(int i=1;i<s3.length;i++) {
			//System.out.println(i);
			
			cf3.mul(new Polynom(s3[i]));
			//System.out.println(cf3+"talya");
		}
		//System.out.println(cf3+"telepun1");
		ComplexFunction cf = new ComplexFunction(Operation.Plus, p1,p2);
		//System.out.println("cf="+cf);
		ComplexFunction cf4 = new ComplexFunction("div", new Polynom("x +1"),cf3);
		//System.out.println("cf4="+cf4);
		cf4.plus(new Monom("2"));
		//System.out.println("cf4.2="+cf4);
		ans.add(cf.copy());
		//System.out.println("cfCopy="+cf.copy());
		ans.add(cf4.copy());
		//System.out.println("cf4="+cf4);
		//System.out.println("cf4Copy="+cf4.copy());
		cf.div(p1);
		ans.add(cf.copy());
		...
		for (int i = 0; i < ans.size(); i++) {
			System.out.println(((Functions_GUI)ans).ARRAY_function.get(i).toString());
		}
		return ans;
	}
}
